# LLM Knowledge Graph Extraction System
...
Sample processing times (from `outputs/processing_times/multimodal_construction_time.json`):

| Provider | Model | Mode | Time (seconds) |
|----------|-------|------|----------------|
| Azure | GPT-4o | Multimodal/Parallel | 5.42 |
| Vertex AI | Gemini-1.5-Pro | Multimodal/Parallel | 28.32 |
| Vertex AI | Gemini-2.5-Flash | Multimodal/Parallel | 381.65 |
...
**Built with ❤️ for extracting insights from financial documents**
